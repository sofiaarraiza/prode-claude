        ...
        <div className="bg-white rounded-3xl shadow-sm p-5">
          ...
          <div className="space-y-3 text-sm text-gray-600">
            <div className="flex items-start gap-2">
              <span className="w-6 h-6 rounded-lg bg-[#003DA5] text-white text-xs font-bold flex items-center justify-center flex-shrink-0 mt-0.5">
                3
              </span>
              <div>
                <strong>Resultado exacto:</strong> Acertás el marcador exacto
                del partido (ej: predecís 2-1 y sale 2-1)
              </div>
            </div>
            <div className="flex items-start gap-2">
              <span className="w-6 h-6 rounded-lg bg-amber-400 text-white text-xs font-bold flex items-center justify-center flex-shrink-0 mt-0.5">
                1
              </span>
              <div>
                <strong>Ganador o empate:</strong> Acertás quién gana o que
                empatan, pero no el marcador exacto
              </div>
            </div>
            <div className="flex items-start gap-2">
              <span className="w-6 h-6 rounded-lg bg-gray-200 text-gray-500 text-xs font-bold flex items-center justify-center flex-shrink-0 mt-0.5">
                0
              </span>
              <div>
                <strong>Sin puntos:</strong> El resultado no coincide con tu
                predicción
              </div>
            </div>
            <div className="bg-amber-50 border border-amber-100 rounded-xl p-3 mt-2">
              <p className="text-amber-700 text-xs flex items-start gap-1.5">
                ...
                <span>
                  ...
                  <strong>7 días antes</strong> de cada partido. Pasada esa
                  fecha, se bloquean.
                </span>
              </p>
            </div>
            <div className="bg-gray-50 border border-gray-100 rounded-xl p-3">
              <p className="text-gray-500 text-xs flex items-start gap-1.5">
                <span>💰</span>
                <span>
                  El sistema de apuestas se organiza por fuera de la app. El
                  ganador del grupo es quien más puntos acumule al final de la
                  fase de grupos.
                </span>
              </p>
            </div>
