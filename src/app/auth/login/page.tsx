...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-dvh bg-fifa-pattern flex flex-col">
      ...
      {/* Form card */}
      <div className="flex-1 bg-[#F0F4FF] rounded-t-3xl px-6 pt-8 pb-10">
        {/* Google button */}
        <button
          onClick={handleGoogle}
          disabled={loading}
          className="flex items-center justify-center gap-3 w-full bg-white border-2 border-gray-200 text-gray-700 font-semibold py-4 px-6 rounded-2xl text-base shadow-sm active:scale-95 transition-transform disabled:opacity-50 mb-6"
        >
          ...
          <form onSubmit={handleEmail} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full bg-white border-2 border-gray-200 rounded-2xl px-4 py-3.5 text-gray-800 text-base focus:outline-none focus:border-[#003DA5] transition-colors"
              />
            </div>
            <div>
              <label className="block text-xs font-semibold text-gray-500 mb-1.5 tracking-wide uppercase">Contraseña</label>
              <input
                type="password"
                value={password}
        ...
        <p className="text-center text-gray-500 text-sm mt-6">
          ...
          <button
            ...
            className="font-semibold text-[#003DA5]"
          >
