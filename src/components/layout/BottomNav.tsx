    ...
    icon: (active: boolean) => (
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 0c2.5 2.5 4 5.5 4 10s-1.5 7.5-4 10m0-20c-2.5 2.5-4 5.5-4 10s1.5 7.5 4 10M2 12h20"
        />
      </svg>
    ),
  },
